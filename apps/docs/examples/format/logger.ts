...
class Logger {
	...
	static info(message: string, _timeZone: TimeZone | null): void {
		Logger.log("info", message, timezone);
	}

	static error(message: string, _timeZone: TimeZone | null): void {
		Logger.log("error", message, timezone);
	}

	static debug(message: string, _timeZone: TimeZone | null): void {
