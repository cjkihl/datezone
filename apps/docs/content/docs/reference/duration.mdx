...
```ts
import { intervalToDuration } from "@datezone/duration";
```
...
```ts
import { intervalToDurationBase } from "@datezone/duration";
```
...
```ts
import { areIntervalsOverlapping } from "@datezone/duration";
```
...
```ts
import { clamp } from "@datezone/duration";
```
