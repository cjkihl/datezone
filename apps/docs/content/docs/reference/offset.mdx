...
<CodeExample tabs={[{ name: "Example 1", file: "reference/offset/example-1.ts" }]} />
...
<CodeExample tabs={[{ name: "Example 2", file: "reference/offset/example-2.ts" }]} />
...
<CodeExample tabs={[{ name: "Example 3", file: "reference/offset/example-3.ts" }]} />
...
<CodeExample tabs={[{ name: "Example 4", file: "reference/offset/example-4.ts" }]} />
...
<CodeExample tabs={[{ name: "Example 5", file: "reference/offset/example-5.ts" }]} />
