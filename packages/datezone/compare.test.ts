...
describe("isBefore", () => {
    test("should return true when first date is before second", () => {
        expect(isBefore(TEST_DATE_2024_01_15, TEST_DATE_2024_01_16, UTC_TZ)).toBe(true);
        expect(isBefore(
    ...
    test("should return false when first date is after second", () => {
        expect(isBefore(TEST_DATE_2024_01_16, TEST_DATE_2024_01_15, UTC_TZ)).toBe(false);
        expect(isBefore(
            { year: 2024, month: 1, day: 16 },
            { year: 2024, month: 1, day: 15 },
            UTC_TZ
    ...
    test("should return false when dates are equal", () => {
        expect(isBefore(TEST_DATE_2024_01_15, TEST_DATE_2024_01_15, UTC_TZ)).toBe(false);
        expect(isBefore(
            { year: 2024, month: 1, day: 15 },
            { year: 2024, month: 1, day: 15 },
            UTC_TZ
...
describe("isAfter", () => {
    test("should return true when first date is after second", () => {
        expect(isAfter(TEST_DATE_2024_01_16, TEST_DATE_2024_01_15, UTC_TZ)).toBe(true);
        expect(isAfter(
            { year: 2024, month: 1, day: 16 },
            { year: 2024, month: 1, day: 15 },
            UTC_TZ
    ...
    test("should return false when first date is before second", () => {
        expect(isAfter(TEST_DATE_2024_01_15, TEST_DATE_2024_01_16, UTC_TZ)).toBe(false);
        expect(isAfter(
            { year: 2024, month: 1, day: 15 },
            { year: 2024, month: 1, day: 16 },
            UTC_TZ
    ...
    test("should return false when dates are equal", () => {
        expect(isAfter(TEST_DATE_2024_01_15, TEST_DATE_2024_01_15, UTC_TZ)).toBe(false);
        expect(isAfter(
            { year: 2024, month: 1, day: 15 },
            { year: 2024, month: 1, day: 15 },
            UTC_TZ
...
describe("isEqual", () => {
    test("should return true for equal timestamps", () => {
        expect(isEqual(TEST_DATE_2024_01_15, TEST_DATE_2024_01_15, UTC_TZ)).toBe(true);
    });
    ...
    test("should return false for different dates", () => {
        expect(isEqual(TEST_DATE_2024_01_15, TEST_DATE_2024_01_16, UTC_TZ)).toBe(false);
        expect(isEqual(
            { year: 2024, month: 1, day: 15 },
            { year: 2024, month: 1, day: 16 },
            UTC_TZ
...
describe("isSameDay", () => {
    ...
    test("should return false for different days", () => {
        expect(isSameDay(TEST_DATE_2024_01_15, TEST_DATE_2024_01_16, UTC_TZ)).toBe(false);
        expect(isSameDay(
            { year: 2024, month: 1, day: 15 },
            { year: 2024, month: 1, day: 16 },
            UTC_TZ
...
describe("isSameWeek", () => {
    test("should return true for dates in same week", () => {
        ...
        expect(isSameWeek(TEST_DATE_2024_01_15, TEST_DATE_2024_01_16, UTC_TZ)).toBe(true);
        expect(isSameWeek(
...
describe("Edge cases", () => {
    test("should handle leap year dates", () => {
        ...
        expect(isSameMonth(leapDay2024, { year: 2024, month: 2, day: 28 }, UTC_TZ)).toBe(true);
